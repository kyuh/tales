...
But let's say we are interested not in the average number of events we see, but the probability of seeing a certain number of them. (For example, what is the chance we see 8 cars?) We intuitively expect the likelihood of seeing way fewer or way more events than the average to be pretty low - in the above example, seeing only 1 car, or seeing 300 cars, would be pretty unlikely. But what is the exact function like?
