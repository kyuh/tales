...
\item What is the probability that our amoeba family doesn't die out at all -- and simply lives on forever? In particular, under what conditions (i.e. for what values of $p$) is the amoeba family certain to die?
\end{enumerate}
\hfill
\end{problem}
...
Suppose we have the situation in Problem \ref{pr:amoeba-ngen}, except now with $m$ starting amoebas. % TODO: Say to mention in terms of pref problem's terms
\end{problem}
...
Suppose we have the situation described in Problem \ref{pr:amoeba-ngen}, but we now have a "magical amoeba" that divides into $k$ children (and so does its descendants). 
