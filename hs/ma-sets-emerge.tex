...
Then to show that $\lim_{n \rightarrow \infty} x_n \neq b$, consider $\epsilon = (x_0 - b)/2$. From Lemma \ref{l:fp-iter-increasing-lower-bound}, we know that for \emph{every} $n$, $x_n > x_0$ -- and as a consequence:
