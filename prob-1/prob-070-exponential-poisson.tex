...
\begin{align*}
\frac{dG_t(z)}{dt} &= \lambda (1-z) G_t(z)
\end{align*}
...
So what did we do here? In order to get information about $G_t(z)$, we used a trick to get information about its derivative with respect to time, in order to get a useful differential equation. 
